...
const generateSpecialDatesTimeSeries = (specialDates: SpecialDate[]) => {
  const timeSeries = specialDates.map((specialDate) => {
...
const generateSpecialDatesMetOfficeJSON = (specialDates: SpecialDate[]) => {
    ...
    features: [
      {
        ...
        properties: {
          ...
          timeSeries: generateSpecialDatesTimeSeries(specialDates),
        },
      },
    ],
  };
